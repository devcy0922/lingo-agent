...
| QA 용어 4/5 미만, 의미·자연스러움·UI 3/5 미만, 항목 평균 3.5/5 미만 또는 critical error | 실패 키만 재시도 → 3회 초과 시 `exit(2)` |
...
| QA Judge | 변경된 모든 키 대상, 용어 hard gate와 항목 평균 기준, critical error 차단 |
